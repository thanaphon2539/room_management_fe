...
const invoiceBillDetail = async (input: {
  nameRoom: string;
  year: number;
  month: number;
  type: any;
  ...
  try {
    const response = await axios.post(`${apiUrl}/bill/invoice/detail`, input, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
      },
...
const receiptBillCopy = async (input: {
  nameRoom: string;
  year: number;
  month: number;
  type: any;
  ...
  try {
    const response = await axios.post(`${apiUrl}/bill/receipt/copy`, input, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
      },
